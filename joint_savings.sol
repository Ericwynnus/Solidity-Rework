...
Third Time is a charm by Eric Wynn
---------------------
...
// Define a new contract named `JointSavings`
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        // YOUR CODE HERE!
        function balance(uint amount, address payable recipient) public {
        ...
        */
        // YOUR CODE HERE! (COme back to this one)
        ...
        // YOUR CODE HERE!
        function sendRemittance() public payable {
    ...
    // Define a `public payable` function named `deposit`.
        ...
        */
        // YOUR CODE HERE! (Nt sure about this here)
        contractBalance = address(this).balance;
    }
